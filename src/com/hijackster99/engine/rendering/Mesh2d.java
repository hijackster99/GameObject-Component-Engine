...
public class Mesh2d {
	...
	public Mesh2d(Vertex[] vertices, int[] indices, boolean calcNormals) {
	...
	private void addVertices(Vertex[] vertices, int[] indices, boolean calcNormals) {
		...
		glBufferData(GL_ARRAY_BUFFER, Util.createFlipped2dBuffer(vertices), GL_STATIC_DRAW);
		
		glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, resource.getIbo());
		glBufferData(GL_ELEMENT_ARRAY_BUFFER, Util.createFlipped2dBuffer(indices), GL_STATIC_DRAW);
	}
	...
	public void draw(int mode) {
		...
		glVertexAttribPointer(2, 2, GL_FLOAT, false, Vertex.SIZE * 4, 16);
