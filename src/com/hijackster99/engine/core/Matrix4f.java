...
public class Matrix4f {
	...
	public Matrix4f initPerspective(float fov, float aspect, float zNear, float zFar) {
		...
		float radius = (float)Math.tan(fov/2);
		float sRadius = radius * aspect;
		float zRange = zNear - zFar;
		
		m[0][0] = 1.0f / sRadius;	m[0][1] = 0;				m[0][2] = 0;						m[0][3] = 0;
		m[1][0] = 0;				m[1][1] = 1.0f / radius;	m[1][2] = 0;						m[1][3] = 0;
